...
class OSF_Metabox {
    ...
    private function page_meta_box_tabs() {
        ...
        $cmb2 = new_cmb2_box(array(
            ...
            'title'         => __('Page Setting', 'rehomes-core'),
            ...
            'tabs'          => array(
                ...
                array(
                    ...
                    'title'  => __('Breadcrumb', 'rehomes-core'),
                    'fields' => array(
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable Sidebar', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Sidebar Width', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Enable Page Title', 'rehomes-core'),
        ...
        if (osf_is_elementor_activated()) {
            $cmb2->add_field(array(
                'name'    => __('Enable Full Page', 'rehomes-core'),
        ...
        // Header
        $cmb2->add_field(array(
            'name'        => __('Enable Custom Header', 'rehomes-core'),
        ...
        $headers = wp_parse_args($this->get_post_type_data('header'), array(
            'default' => esc_html__('Default', 'rehomes-core'),
        ));
        $cmb2->add_field(array(
            'name'             => __('Layout', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable Breadcrumb', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Heading Color', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Breadcrumb Text Color', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Breadcrumb Background Color', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'         => __('Breadcrumb Background', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable Custom Footer', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Padding Top', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Enable Fixed Footer', 'rehomes-core'),
    ...
    private function header_builder($prefix = 'osf_') {
        $cmb2 = new_cmb2_box(array(
            ...
            'title'        => __('Header Settings', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'        => __('Enable AbHeader Absolute', 'rehomes-core'),
        ...
        $cmb2->add_field(array(
            'name'    => __('Background Color Mobile', 'rehomes-core'),
