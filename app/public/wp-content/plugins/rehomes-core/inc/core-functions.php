...
function osf_get_google_fonts() {
    $content = file_get_contents(REHOME_CORE_PLUGIN_DIR . 'webfonts.json');
...
function time_elapsed_string($datetime, $full = false) {
    ...
    $string = array(
        'y' => __('year', 'rehomes-core'),
        'm' => __('month', 'rehomes-core'),
        'w' => __('week', 'rehomes-core'),
        'd' => __('day', 'rehomes-core'),
//        'h' => __('hour', 'rehomes-core'),
//        'i' => __('minute', 'rehomes-core'),
//        's' => __('second', 'rehomes-core'),
    );
    ...
    return $string ? implode(', ', $string) . __(' left', 'rehomes-core') : __('just now', 'rehomes-core');
}
