...
//  Container Width
// ==================================================
$containerSelector = '.container, #content ,.single-product .related.products, .single-product .up-sells.products, ul.elementor-nav-menu--dropdown.mega-containerwidth > li.mega-menu-item > .elementor';
...
////  Padding contatiner
//// ==================================================
$containerPaddingSelector = '.container, #content , .container-fluid, .single-product .related.products, .single-product .up-sells.products, ul.elementor-nav-menu--dropdown.mega-containerwidth > li.mega-menu-item > .elementor';
