...
class OSF_Widget_Layered_Nav extends WC_Widget {
    ...
    public function __construct() {
        ...
        $this->widget_description = __( 'Display a list of attributes to filter products in your store.(OSF custom)', 'rehomes-core' );
        $this->widget_id          = 'otf_woocommerce_layered_nav';
        $this->widget_name        = __( 'OSF Filter Products by Attribute', 'rehomes-core' );
        parent::__construct();
    }
    ...
    public function init_settings() {
        ...
        $this->settings = array(
            'title' => array(
                'type'  => 'text',
                'std'   => __( 'Filter by', 'rehomes-core' ),
                'label' => __( 'Title', 'rehomes-core' ),
            ),
            'attribute' => array(
                'type'    => 'select',
                'std'     => '',
                'label'   => __( 'Attribute', 'rehomes-core' ),
                'options' => $attribute_array,
            ),
            'display_type' => array(
                'type'    => 'select',
                'std'     => 'list',
                'label'   => __( 'Display type', 'rehomes-core' ),
                'options' => array(
                    'list'     => __( 'List', 'rehomes-core' ),
            ...
            'style' => array(
                ...
                'options' => array(
                    'one_column'          => __( '1 Column', 'rehomes-core' ),
                    'two_columns'   => __( '2 Columns', 'rehomes-core' ),
                    'inline'        => __( 'Inline', 'rehomes-core' ),
                ),
            ),
            'query_type' => array(
                'type'    => 'select',
                'std'     => 'and',
                'label'   => __( 'Query type', 'rehomes-core' ),
                'options' => array(
                    'and' => __( 'AND', 'rehomes-core' ),
                    'or'  => __( 'OR', 'rehomes-core' ),
                ),
            ),
        );
    }
