...
class OSF_Element_Site_Logo extends Widget_Image {
    ...
    public function get_title() {
        return __( 'Opal Site Logo', 'rehomes-core' );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_extra',
            [
                'label' => __( 'Logo Site', 'rehomes-core' ),
            ]
        );
        $this->add_control(
            'logo_select',
            [
                'label' => __( 'Image from', 'rehomes-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'site_logo',
                'options' => [
                    'site_logo' => __( 'Use Site Logo', 'rehomes-core' ),
                    'customize' => __( 'Custom Logo', 'rehomes-core' ),
                ]
            ]
        );
        ...
        $this->add_control(
            'caption_source',
            [
                'label' => __( 'Caption', 'rehomes-core' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'none' => __( 'None', 'rehomes-core' ),
                    'attachment' => __( 'Attachment Caption', 'rehomes-core' ),
                    'custom' => __( 'Custom Caption', 'rehomes-core' ),
                ],
                'default' => 'none',
            ]
        );
        ...
        $this->add_control(
            'caption',
            [
                'label' => __( 'Custom Caption', 'rehomes-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => '',
                'placeholder' => __( 'Enter your image caption', 'rehomes-core' ),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'none' => __( 'None', 'rehomes-core' ),
                    'file' => __( 'Media File', 'rehomes-core' ),
                    'custom' => __( 'Custom URL', 'rehomes-core' ),
                ],
            ]
        );
        ...
        $this->add_control(
            'open_lightbox',
            [
                'label' => __( 'Lightbox', 'rehomes-core' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'default',
                'options' => [
                    'default' => __( 'Default', 'rehomes-core' ),
                    'yes' => __( 'Yes', 'rehomes-core' ),
                    'no' => __( 'No', 'rehomes-core' ),
                ],
                'condition' => [
                    'link_to' => 'file',
                ],
