...
class OSF_Widget_Toggle extends Widget_Toggle {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control('tab_title', [
            ...
            'default'     => __('Toggle Title', 'rehomes-core'),
            'label_block' => true,
        ]);
        ...
        $repeater->add_control('tab_content', [
            ...
            'default'    => __('Toggle Content', 'rehomes-core'),
            'show_label' => false,
        ]);
        ...
        $this->add_control(
            'tabs',
            [
                'label'       => __('Toggle Items', 'rehomes-core'),
                'type'        => Controls_Manager::REPEATER,
                'fields'      => $repeater->get_controls(),
                'default'     => [
                    [
                        'tab_title'   => __('Toggle #1', 'rehomes-core'),
                        'tab_content' => __('I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'rehomes-core'),
                    ],
                    [
                        'tab_title'   => __('Toggle #2', 'rehomes-core'),
                        'tab_content' => __('I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'rehomes-core'),
                    ],
                ],
        ...
        $this->add_control(
            'show_item_first',
            [
                'label' => __('Show Item First', 'rehomes-core'),
        ...
        $this->add_control(
            'event_type',
            [
                'label'        => __('Event Type', 'rehomes-core'),
                'type'         => Controls_Manager::SELECT,
                'options'      => array(
                    'toggle'    => 'Toggle',
                    'accordion' => 'Accordion'
        ...
        $this->add_control(
            ...
            [
                ...
                'options'     => [
                    'left'  => [
                        'title' => __('Start', 'rehomes-core'),
                        'icon'  => 'eicon-h-align-left',
                    ],
                    'right' => [
                        'title' => __('End', 'rehomes-core'),
