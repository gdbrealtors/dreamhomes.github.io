...
class OSF_Elementor_Text_Editor extends Widget_Text_Editor {
    ...
    public function get_title() {
        return __('Text Editor', 'rehomes-core');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_editor',
            [
                'label' => __('Text Editor', 'rehomes-core'),
            ]
        );
        ...
        $this->add_control(
            'drop_cap', [
                'label'              => __('Drop Cap', 'rehomes-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Background_Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
