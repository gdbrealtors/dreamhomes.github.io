...
class OSF_Elementor_Vertical_Scroll extends Widget_Base {
    ...
    public function get_title() {
        return __('Opal Vertical Scroll', 'rehomes-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control('content_type',
            [
                'label'       => __('Content Type', 'rehomes-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'ids'       => __('Section ID', 'rehomes-core'),
                    'templates' => __('Elementor Templates', 'rehomes-core')
                ],
                'default'     => 'templates',
                'description' => __('Choose which method you prefer to insert sections.', 'rehomes-core')
            ]
        );
        ...
        $temp_repeater->add_control('section_template',
            [
                'label'    => __('Elementor Template', 'rehomes-core'),
                'type'     => Controls_Manager::SELECT,
                'options'  => $options,
                'types'    => $types,
                'multiple' => false,
        ...
        $this->add_control('section_repeater',
            [
                'label'       => __('Sections', 'rehomes-core'),
        ...
        $id_repeater->add_control('section_id',
            [
                'label'   => __('Section ID', 'rehomes-core'),
        ...
        $this->add_control('dots_tooltips_switcher',
            [
                'label'   => __('Dots Tooltips', 'rehomes-core'),
        ...
        $this->add_control('dots_shape',
            [
                ...
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'circ'  => __('Circles', 'rehomes-core'),
                    'lines' => __('Lines', 'rehomes-core')
                ],
                'default'   => 'circ',
                'condition' => [
        ...
        $this->add_control('dots_tooltips',
            [
                'label'       => __('Dots Tooltips Text', 'rehomes-core'),
                'type'        => Controls_Manager::TEXT,
                'dynamic'     => ['active' => true],
                'description' => __('Add text for each navigation dot separated by \',\'', 'rehomes-core'),
                'condition'   => [
                    'dots_tooltips_switcher' => 'yes'
                ]
            ]
        ...
        $this->start_controls_section('nav_menu',
            [
                'label' => __('Navigation', 'rehomes-core'),
            ]
        );

        $this->add_control('nav_menu_switch',
            [
                'label'       => __('Navigation Menu', 'rehomes-core'),
                'type'        => Controls_Manager::SWITCHER,
                'description' => __('This option works only on the frontend', 'rehomes-core'),
            ]
        );
        ...
        $this->add_control('navigation_menu_pos',
            [
                ...
                'type'      => Controls_Manager::SELECT,
                'options'   => [
                    'left'  => __('Left', 'rehomes-core'),
                    'right' => __('Right', 'rehomes-core'),
                ],
                'default'   => 'left',
                'condition' => [
                    'nav_menu_switch' => 'yes'
        ...
        $this->add_responsive_control('navigation_menu_pos_offset_top',
            [
                'label'      => __('Offset Top', 'rehomes-core'),
        ...
        $this->add_responsive_control('navigation_menu_pos_offset_left',
            [
                'label'      => __('Offset Left', 'rehomes-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
        ...
        $this->add_responsive_control('navigation_menu_pos_offset_right',
            [
                'label'      => __('Offset Right', 'rehomes-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
        ...
        $nav_repeater->add_control('nav_menu_item',
            [
                'label'   => __('List Item', 'rehomes-core'),
                'type'    => Controls_Manager::TEXT,
                'dynamic' => ['active' => true],
            ]
        );
        ...
        $this->add_control('nav_menu_repeater',
            [
                'label'       => __('Menu Items', 'rehomes-core'),
                'type'        => Controls_Manager::REPEATER,
        ...
        $this->add_control('navigation_dots_pos',
            [
                'label'   => __('Dots Horizontal Position', 'rehomes-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'left'  => __('Left', 'rehomes-core'),
                    'right' => __('Right', 'rehomes-core'),
        ...
        $this->add_control('navigation_dots_v_pos',
            [
                'label'   => __('Dots Vertical Position', 'rehomes-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
        ...
        $this->start_controls_section('advanced_settings',
            [
                'label' => __('Scroll Settings', 'rehomes-core'),
            ]
        );

        $this->add_control('scroll_speed',
            [
                'label'       => __('Scroll Speed', 'rehomes-core'),
                'type'        => Controls_Manager::NUMBER,
                'description' => __('Set scolling speed in seconds, default: 0.7', 'rehomes-core'),
            ]
        );

        $this->add_control('full_section',
            [
                'label'   => __('Full Section Scroll', 'rehomes-core'),
                'type'    => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control('full_section_touch',
            [
                'label'     => __('Full Section Scroll on Touch', 'rehomes-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'full_section' => 'yes'
        ...
        $this->start_controls_section('navigation_style',
            [
                'label' => __('Navigation Dots', 'rehomes-core'),
        ...
        $this->start_controls_tab('tooltips_style_tab',
            [
                'label'     => __('Tooltips', 'rehomes-core'),
                'condition' => [
                    'dots_tooltips_switcher' => 'yes'
                ]
            ]
        ...
        $this->add_control('tooltips_color',
            [
                'label'     => __('Tooltips Text Color', 'rehomes-core'),
        ...
        $this->add_control('tooltips_background',
            [
                'label'     => __('Tooltips Background', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'global'    => [
                    'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Colors::COLOR_PRIMARY,
                ],
        ...
        $this->start_controls_tab('dots_style_tab',
            [
                'label' => __('Dots', 'rehomes-core'),
            ]
        );

        $this->add_control('dots_color',
            [
                'label'     => __('Dots Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control('active_dot_color',
            [
                'label'     => __('Active Dot Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'global'    => [
                    'default' => \Elementor\Core\Kits\Documents\Tabs\Global_Colors::COLOR_PRIMARY,
                ],
        ...
        $this->add_control('dots_border_color',
            [
                'label'     => __('Dots Border Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab('container_style_tab',
            [
                'label' => __('Container', 'rehomes-core'),
            ]
        );
...
$widgets_manager->register_widget_type(new OSF_Elementor_Vertical_Scroll());