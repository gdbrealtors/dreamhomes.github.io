...
class  OSF_Elementor_Heading extends Widget_Heading {
    ...
    public function get_title() {
        return __('Opal Heading', 'rehomes-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => __('Add Your Heading Text Here', 'rehomes-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'small'   => __('Small', 'rehomes-core'),
                    'medium'  => __('Medium', 'rehomes-core'),
                    'large'   => __('Large', 'rehomes-core'),
                    'xl'      => __('XL', 'rehomes-core'),
                    'xxl'     => __('XXL', 'rehomes-core'),
                ],
            ]
        );
