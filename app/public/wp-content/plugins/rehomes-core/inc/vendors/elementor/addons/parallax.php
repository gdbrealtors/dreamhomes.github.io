...
class OSF_Elementor_Parallax {
	...
	public function osf_paralax_render( $element ) {
		...
		if ( $settings['osf_section_parallax_switcher'] === 'yes' ) {
			foreach ( $repeater_list as $layer ):
				...
				echo '<div class="parallax-layer elementor-repeater-item-' . $layer['_id'] . ' f-' . $layer['osf_section_parallax_item_svg_color_type'] . '" data-parallax="' . $parallax_mouse . '" data-rate="' . $layer['osf_section_parallax_rate'] . '">' . $html . '</div>';
			endforeach;
			?>
            <script type="text/javascript">
                (function ($) {
                    ...
                    $(' .elementor-repeater-item-<?php echo $layer['_id'];?>').prependTo($('.elementor-element-<?php echo $element->get_id(); ?>')).css({
	...
	public function register_controls( $element, $args ) {
		...
		$element->start_controls_section(
			...
			[
				'label' => __( 'Multi Parallax ', 'rehomes-core' ),
				'tab'   => Controls_Manager::TAB_LAYOUT,
			]
		);
		$element->add_control( 'osf_section_parallax_switcher',
			[
				'label' => __( 'Enable Parallax', 'rehomes-core' ),
		...
		$element->add_control(
			...
			[
				'label'     => __( 'Parallax Items', 'rehomes-core' ),
				...
				'fields'    => [
					[
						'name'    => 'osf_section_parallax_item_style',
						'label'   => __( 'Parallax Type', 'rehomes-core' ),
						'type'    => Controls_Manager::SELECT,
						'options' => [
							'image' => __( 'Image', 'rehomes-core' ),
							'svg'   => __( 'Opal Style', 'rehomes-core' ),
						],
						'default' => 'image',
					],
					[
						'name'      => 'osf_section_parallax_item_svg_style',
						'label'     => __( 'Opal Style', 'rehomes-core' ),
						'type'      => Controls_Manager::SELECT,
						'options'   => [
							'0' => __( 'Style 1', 'rehomes-core' ),
							'1' => __( 'Style 2', 'rehomes-core' ),
							'2' => __( 'Style 3', 'rehomes-core' ),
							'3' => __( 'Style 4', 'rehomes-core' ),
						],
						'default'   => '1',
						'condition' => [
					...
					[
						'name'      => 'osf_section_parallax_item_svg_color_type',
						'label'     => __( 'Opal Style Color', 'rehomes-core' ),
						'type'      => Controls_Manager::SELECT,
						'options'   => [
					...
					[
						'name'       => 'osf_section_parallax_item_svg_color',
						'label'      => __( 'Custom Color', 'rehomes-core' ),
					...
					[
						...
						'selectors'  => [
							'{{WRAPPER}} {{CURRENT_ITEM}}.parallax-layer svg' => 'width: {{SIZE}}{{UNIT}};',
						],
						'condition'  => [
							'osf_section_parallax_item_style' => 'svg'
						]
					...
					[
						...
						'selectors'  => [
							'{{WRAPPER}} {{CURRENT_ITEM}}.parallax-layer svg' => 'height: {{SIZE}}{{UNIT}};',
						],
						'condition'  => [
							'osf_section_parallax_item_style' => 'svg'
						]
					...
					[
						'name'      => 'osf_section_parallax_item_svg_rotate',
					...
					[
						'name'      => 'osf_section_parallax_image',
					...
					[
						'name'       => 'osf_section_parallax_position_h',
						'label'      => __( 'Position h', 'rehomes-core' ),
						'type'       => Controls_Manager::SLIDER,
						'range'      => [
							'px' => [
								'min' => 0,
					...
					[
						'name'       => 'osf_section_parallax_position_v',
						'label'      => __( 'Position v', 'rehomes-core' ),
						'type'       => Controls_Manager::SLIDER,
						'range'      => [
							'px' => [
								'min' => 0,
					...
					[
						'name'    => 'osf_section_parallax_background_size',
						'label'   => __( 'Background Size', 'rehomes-core' ),
						'type'    => Controls_Manager::SELECT,
						'default' => 'auto',
						'options' => [
							'auto'    => __( 'Auto', 'rehomes-core' ),
							'cover'   => __( 'Cover', 'rehomes-core' ),
							'contain' => __( 'Contain', 'rehomes-core' ),
						],
					],
					[
						'name'        => 'osf_section_parallax_z_index',
						'label'       => __( 'Z-Index', 'rehomes-core' ),
						'type'        => Controls_Manager::NUMBER,
						'default'     => 1,
						'description' => __( 'Choose z-index for the parallax layer, default: 3', 'rehomes-core' ),
					],
					[
						'name'        => 'osf_section_parallax_mouse',
						'label'       => __( 'Mousemove Parallax', 'rehomes-core' ),
						'type'        => Controls_Manager::SWITCHER,
						'description' => __( 'Enable or disable mousemove interaction', 'rehomes-core' ),
					],
					[
						'name'    => 'osf_section_parallax_rate',
						'label'   => __( 'Rate', 'rehomes-core' ),
						'type'    => Controls_Manager::NUMBER,
						'default' => - 10,
						'min'     => - 20,
						'max'     => 20,
