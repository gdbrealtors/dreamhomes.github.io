...
class OSF_Elementor_Image_Hotspots_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section('image_hotspots_image_section',
            [
                'label' => esc_html__('Image', 'rehomes-core'),
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_icons_settings',
            [
                'label' => esc_html__('Hotspots', 'rehomes-core'),
            ]
        );
        ...
        $repeater->add_responsive_control('preimum_image_hotspots_main_icons_horizontal_position',
            [
                'label'      => esc_html__('Horizontal Position', 'rehomes-core'),
        ...
        $repeater->add_responsive_control('preimum_image_hotspots_main_icons_vertical_position',
            [
                'label'      => esc_html__('Vertical Position', 'rehomes-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'range'      => [
                    'px' => [
        ...
        $repeater->add_control('image_hotspots_content',
            [
                'label'   => esc_html__('Content to Show', 'rehomes-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'text_editor'         => esc_html__('Text Editor', 'rehomes-core'),
                    'elementor_templates' => esc_html__('Elementor Template', 'rehomes-core'),
                ],
                'default' => 'text_editor'
            ]
        );
        ...
        $repeater->add_control('image_hotspots_tooltips_info',
            ['label'       => esc_html__('Infomation', 'rehomes-core'),
             'type'        => Controls_Manager::WYSIWYG,
             'default'     => 'Lorem ipsum',
             'dynamic'     => ['active' => true],
             'label_block' => true,
        ...
        $repeater->add_control('image_hotspots_tooltips_temp',
            [
                'label'     => esc_html__('Teamplate ID', 'rehomes-core'),
        ...
        $repeater->add_control('image_hotspots_link_switcher',
            [
                'label'       => esc_html__('Link', 'rehomes-core'),
                'type'        => Controls_Manager::SWITCHER,
                'description' => esc_html__('Add a custom link or select an existing page link', 'rehomes-core'),
            ]);

        $repeater->add_control('image_hotspots_link_type',
            [
                'label'       => esc_html__('Link/URL', 'rehomes-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'url'  => esc_html__('URL', 'rehomes-core'),
                    'link' => esc_html__('Existing Page', 'rehomes-core'),
                ],
                'default'     => 'url',
                'condition'   => [
        ...
        $repeater->add_control('image_hotspots_url',
            [
                'label'       => esc_html__('URL', 'rehomes-core'),
        ...
        $repeater->add_control('image_hotspots_link_text',
            [
                'label'       => esc_html__('Link Title', 'rehomes-core'),
        ...
        $this->add_control('image_hotspots_icons_animation',
            [
                'label' => esc_html__('Radar Animation', 'rehomes-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_tooltips_section',
            [
                'label' => esc_html__('Tooltips', 'rehomes-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'   => esc_html__('Trigger', 'rehomes-core'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'click' => esc_html__('Click', 'rehomes-core'),
                    'hover' => esc_html__('Hover', 'rehomes-core'),
                ],
                'default' => 'hover'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Show Arrow', 'rehomes-core'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'rehomes-core'),
                'label_off' => esc_html__('Hide', 'rehomes-core'),
            ]
        );
        ...
        $this->add_control('image_hotspots_tooltips_distance_position',
            [
                'label'   => esc_html__('Spacing', 'rehomes-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('The distance between the origin and the tooltip in pixels, default is 6', 'rehomes-core'),
                'default' => 6,
            ]
        );
        ...
        $this->add_control('image_hotspots_min_width',
            [
                'label'       => esc_html__('Min Width', 'rehomes-core'),
                'type'        => Controls_Manager::SLIDER,
                'range'       => [
                    'px' => [
                        'min' => 0,
                ...
                'description' => esc_html__('Set a minimum width for the tooltip in pixels, default: 0 (auto width)', 'rehomes-core'),
            ]
        );

        $this->add_control('image_hotspots_max_width',
            [
                'label'       => esc_html__('Max Width', 'rehomes-core'),
                'type'        => Controls_Manager::SLIDER,
                'range'       => [
                    'px' => [
                        'min' => 0,
                ...
                'description' => esc_html__('Set a maximum width for the tooltip in pixels, default: null (no max width)', 'rehomes-core'),
            ]
        );

        $this->add_responsive_control('image_hotspots_tooltips_wrapper_height',
            [
                'label'       => esc_html__('Height', 'rehomes-core'),
                'type'        => Controls_Manager::SLIDER,
                'size_units'  => ['px', 'em', '%'],
                'range'       => [
                    'px' => [
        ...
        $this->add_control('image_hotspots_anim',
            [
                'label'       => esc_html__('Animation', 'rehomes-core'),
                'type'        => Controls_Manager::SELECT,
                'options'     => [
                    'fade'  => esc_html__('Fade', 'rehomes-core'),
                    'grow'  => esc_html__('Grow', 'rehomes-core'),
                    'swing' => esc_html__('Swing', 'rehomes-core'),
                    'slide' => esc_html__('Slide', 'rehomes-core'),
                    'fall'  => esc_html__('Fall', 'rehomes-core'),
                ],
                'default'     => 'fade',
                'label_block' => true,
            ]
        ...
        $this->add_control('image_hotspots_anim_dur',
            [
                'label'   => esc_html__('Animation Duration', 'rehomes-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('Set the animation duration in milliseconds, default is 350', 'rehomes-core'),
                'default' => 350,
            ]
        );
        ...
        $this->add_control('image_hotspots_delay',
            [
                'label'   => esc_html__('Delay', 'rehomes-core'),
                'type'    => Controls_Manager::NUMBER,
                'title'   => esc_html__('Set the animation delay in milliseconds, default is 10', 'rehomes-core'),
                'default' => 10,
            ]
        );
        ...
        $this->add_control('image_hotspots_hide',
            [
                'label'        => esc_html__('Hide on Mobiles', 'rehomes-core'),
                'type'         => Controls_Manager::SWITCHER,
                'label_on'     => 'Show',
                'label_off'    => 'Hide',
                'description'  => esc_html__('Hide tooltips on mobile phones', 'rehomes-core'),
                'return_value' => true,
            ]
        );
        ...
        $this->add_control('image_hotspots_infomation_show',
            [
                'label' => esc_html__('Show infomation', 'rehomes-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control('image_hotspots_image_border_radius',
            [
                'label'      => esc_html__('Border Radius', 'rehomes-core'),
                'type'       => Controls_Manager::SLIDER,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->add_responsive_control('image_hotspots_image_padding',
            [
                'label'      => esc_html__('Padding', 'rehomes-core'),
        ...
        $this->add_control('image_hotspots_tooltips_wrapper_color',
            [
                'label'     => esc_html__('Text Color', 'rehomes-core'),
        ...
        $this->add_control('image_hotspots_tooltips_wrapper_background_color',
            [
                'label'     => esc_html__('Background Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_responsive_control('image_hotspots_tooltips_wrapper_margin',
            [
                'label'      => esc_html__('Margin', 'rehomes-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->start_controls_section('img_hotspots_container_style',
            [
                'label' => esc_html__('Container', 'rehomes-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_responsive_control('img_hotspots_container_padding',
            [
                'label'      => esc_html__('Paddding', 'rehomes-core'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
