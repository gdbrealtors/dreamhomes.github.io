...
class OSF_Elementor_Flip_Box extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Opal Flip Box', 'rehomes-core' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Front', 'rehomes-core' ),
			]
		);

		$this->start_controls_tabs( 'side_a_content_tabs' );

		$this->start_controls_tab( 'side_a_content_tab', [ 'label' => __( 'Content', 'rehomes-core' ) ] );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'This is the sub title', 'rehomes-core' ),
...
//				'show_label' => false,
		...
		$this->start_controls_tab( 'side_a_background_tab', [ 'label' => __( 'Background', 'rehomes-core' ) ] );
		...
		$this->add_control(
			...
			[
				'label' => __( 'Background Overlay', 'rehomes-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Back', 'rehomes-core' ),
			]
		);

		$this->start_controls_tabs( 'side_b_content_tabs' );

		$this->start_controls_tab( 'side_b_content_tab', [ 'label' => __( 'Content', 'rehomes-core' ) ] );
		...
		$this->start_controls_tab( 'side_b_background_tab', [ 'label' => __( 'Background', 'rehomes-core' ) ] );
		...
		$this->add_control(
			'flip_effect',
			[
				'label' => __( 'Flip Effect', 'rehomes-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'flip',
				'options' => [
					'flip' => 'Flip',
		...
		$this->add_control(
			'flip_direction',
			[
				'label' => __( 'Flip Direction', 'rehomes-core' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'up',
				'options' => [
					'left' => __( 'Left', 'rehomes-core' ),
					'right' => __( 'Right', 'rehomes-core' ),
					'up' => __( 'Up', 'rehomes-core' ),
					'down' => __( 'Down', 'rehomes-core' ),
				],
				'condition' => [
					'flip_effect!' => [
							'fade',
		...
		$this->add_control(
			'flip_3d',
			[
				'label' => __( '3D Depth', 'rehomes-core' ),
