...
class OSF_Elementor_Countdown extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __( 'Opal Countdown', 'rehomes-core' );
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_countdown',
            [
                'label' => __( 'Countdown', 'rehomes-core' ),
            ]
        );
        ...
        $this->add_control(
            'due_date',
            [
                'label' => __( 'Due Date', 'rehomes-core' ),
                'type' => Controls_Manager::DATE_TIME,
                'default' => date( 'Y-m-d H:i', strtotime( '+1 month' ) + ( get_option( 'gmt_offset' ) * HOUR_IN_SECONDS ) ),
                /* translators: %s: Time zone. */
                'description' => sprintf( __( 'Date set according to your timezone: %s.', 'rehomes-core' ), Utils::get_timezone_string() ),
            ]
        );
        ...
        $this->add_control(
            'show_labels',
            [
                'label' => __( 'Show Label', 'rehomes-core' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'Show', 'rehomes-core' ),
                'label_off' => __( 'Hide', 'rehomes-core' ),
                'default' => 'yes',
        ...
        $this->add_control(
            'custom_labels',
            [
                'label' => __( 'Custom Label', 'rehomes-core' ),
                'type' => Controls_Manager::SWITCHER,
                'condition' => [
                    'show_labels!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __( 'Days', 'rehomes-core' ),
                'placeholder' => __( 'Days', 'rehomes-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_days' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Hours', 'rehomes-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Hours', 'rehomes-core' ),
                'placeholder' => __( 'Hours', 'rehomes-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_hours' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Minutes', 'rehomes-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Minutes', 'rehomes-core' ),
                'placeholder' => __( 'Minutes', 'rehomes-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_minutes' => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Seconds', 'rehomes-core' ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Seconds', 'rehomes-core' ),
                'placeholder' => __( 'Seconds', 'rehomes-core' ),
                'condition' => [
                    'show_labels!' => '',
                    'custom_labels!' => '',
                    'show_seconds' => 'yes',
        ...
        $this->add_responsive_control(
            'container_width',
            [
                'label'      => __( 'Container Width', 'rehomes-core' ),
        ...
        $this->add_responsive_control(
            'items_width',
            [
                'label'      => __( 'Items Width', 'rehomes-core' ),
                'type'       => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'items_height',
            [
                'label'      => __( 'Items Height', 'rehomes-core' ),
                'type'       => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            'show_divider',
            [
                'label' => __('Show Divider', 'rehomes-core'),
                'type'  => Controls_Manager::SWITCHER,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'divider_size',
            [
                'label'     => __('Size Divider', 'rehomes-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'     => [
                    'px' => [
                        'min' => 0,
    ...
    private function _init_default_countdown_labels() {
        $this->_default_countdown_labels = [
            'label_months' => __( 'Months', 'rehomes-core' ),
            'label_weeks' => __( 'Weeks', 'rehomes-core' ),
            'label_days' => __( 'Days', 'rehomes-core' ),
            'label_hours' => __( 'Hours', 'rehomes-core' ),
            'label_minutes' => __( 'Minutes', 'rehomes-core' ),
            'label_seconds' => __( 'Seconds', 'rehomes-core' ),
        ];
    }
