...
class OSF_Elementor_Nav_Menu extends Widget_Base
{
    ...
    {
        return __('Opal Nav Menu', 'rehomes-core');
    }
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'type_menu',
                'options' => [
                    'type_menu' => __('Menu', 'rehomes-core'),
                    'type_location' => __('Location', 'rehomes-core'),
                ],
            ]
        );
        ...
        $this->add_control(
            'location',
            [
                'label' => __('Location', 'rehomes-core'),
                'type' => Controls_Manager::SELECT,
                'default' => '',
                'condition' => [
                    'type_field_menu' => 'type_location'
                ],
                'options' => wp_parse_args(get_registered_nav_menus(), ['' => esc_html__('', 'rehomes-core')]),
                'separator' => 'after',
            ]
        );
        ...
        if (!empty($menus)) {
            $this->add_control(
                ...
                [
                    ...
                    'separator' => 'after',
                    'description' => sprintf(__('Go to the <a href="%s" target="_blank">Menus screen</a> to manage your menus.', 'rehomes-core'), admin_url('nav-menus.php')),
                ]
            );
        } else {
            $this->add_control(
                ...
                [
                    ...
                    'raw' => sprintf(__('<strong>There are no menus in your site.</strong><br>Go to the <a href="%s" target="_blank">Menus screen</a> to create one.', 'rehomes-core'), admin_url('nav-menus.php?action=edit&menu=0')),
                    'separator' => 'after',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'vertical-absolute' => __('Vertical Absolute', 'rehomes-core'),
                ],
        ...
        $this->add_control(
            'vertical_heading',
            [
                'label' => __('Vertical Heading', 'rehomes-core'),
                'type' => Controls_Manager::TEXTAREA,
                'placeholder' => __('Browse Categories', 'rehomes-core'),
                'default' => __('Browse Categories', 'rehomes-core'),
                'condition' => [
        ...
        $this->add_control(
            'pointer',
            [
                'label' => __('Pointer', 'rehomes-core'),
                'type' => Controls_Manager::SELECT,
                'default' => 'none',
                'options' => [
                    'none' => __('None', 'rehomes-core'),
                    'underline' => __('Underline', 'rehomes-core'),
                    'overline' => __('Overline', 'rehomes-core'),
                    'double-line' => __('Double Line', 'rehomes-core'),
                    'framed' => __('Framed', 'rehomes-core'),
                    'text' => __('Text', 'rehomes-core'),
                    'dot' => __('Dot', 'rehomes-core'),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'dot_width',
            [
                'label' => __('Dot Width', 'rehomes-core'),
        ...
        $this->add_responsive_control(
            'dot_height',
            [
                'label' => __('Dot Height', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_control(
            'dot_border_radius',
            [
                'label' => __('Dot Radius', 'rehomes-core'),
        ...
        $this->add_control(
            'indicator',
            [
                'label' => __('Submenu Indicator', 'rehomes-core'),
                'type' => Controls_Manager::SELECT,
                'default' => 'angle',
                'options' => [
                    'none' => __('None', 'rehomes-core'),
                    'classic' => __('Classic', 'rehomes-core'),
                    'chevron' => __('Chevron', 'rehomes-core'),
                    'chevron_right' => __('Chevron Right', 'rehomes-core'),
                    'angle' => __('Angle', 'rehomes-core'),
                    'angle_right' => __('Angle Right', 'rehomes-core'),
                    'plus' => __('Plus', 'rehomes-core'),
                ],
        ...
        $this->add_responsive_control(
            'indicator_fsize',
            [
                'label' => __('Indicator Font Size', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_responsive_control(
            'indicator_size',
            [
                'label' => __('Indicator Size', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_responsive_control(
            'indicator_padding',
            [
                'label' => __('Indicator Spacing', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            'enable_divider_menu',
            [
                'label' => __('Enable Divider', 'rehomes-core'),
        ...
        $this->add_responsive_control(
            'divider_width',
            [
                'label' => __('Divider Width', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_responsive_control(
            'divider_height',
            [
                'label' => __('Divider Height', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 10,
        ...
        $this->add_control(
            ...
            [
                'label' => __('Divider Radius', 'rehomes-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%'],
                'selectors' => [
        ...
        $this->add_responsive_control(
            'subMenusMinWidth',
            [
                'label' => __('Min width Submenu(px)', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 50,
        ...
        $this->add_responsive_control(
            'subMenusMaxWidth',
            [
                'label' => __('Max width Submenu(px)', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 100,
        ...
        $this->add_control(
            ...
            [
                'label' => __('Mobile Dropdown', 'rehomes-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Enable Mobile Menu', 'rehomes-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => 'yes',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'dropdown',
                'options' => [
                    'dropdown' => __('Dropdown', 'rehomes-core'),
                    'canvas' => __('Canvas', 'rehomes-core'),
                    'popup' => __('Popup', 'rehomes-core'),
                ],
                'condition' => [
        ...
        $this->add_control(
            'dropdown',
            [
                'label' => __('Breakpoint', 'rehomes-core'),
                'type' => Controls_Manager::SELECT,
                'default' => 'tablet',
                'options' => [
                    'mobile' => __('Mobile (767px >)', 'rehomes-core'),
                    'tablet' => __('Tablet (1023px >)', 'rehomes-core'),
                    'destop' => __('Destop', 'rehomes-core'),
                ],
        ...
        $this->add_control(
            'full_width',
            [
                'label' => __('Full Width', 'rehomes-core'),
                'type' => Controls_Manager::SWITCHER,
                'description' => __('Stretch the dropdown of the menu to full width.', 'rehomes-core'),
        ...
        $this->add_responsive_control(
            'width_dropdown',
            [
                'label' => __('Width Dropdown', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'aside',
                'options' => [
                    'aside' => __('Aside', 'rehomes-core'),
                    'center' => __('Center', 'rehomes-core'),
                ],
        ...
        $this->add_control(
            'toggle',
            [
                'label' => __('Toggle Button', 'rehomes-core'),
                'type' => Controls_Manager::SELECT,
                'default' => 'burger',
                'options' => [
                    '' => __('None', 'rehomes-core'),
                    'burger' => __('Hamburger', 'rehomes-core'),
                ],
        ...
        $this->add_responsive_control(
            'toggle_align',
            [
                'label' => __('Toggle Align', 'rehomes-core'),
                'type' => Controls_Manager::CHOOSE,
                'default' => 'left',
                'options' => [
                    'left' => [
        ...
        $this->add_control(
            'menu-toggle-title',
            [
                'label' => __('Title Toggle', 'rehomes-core'),
                'default' => 'Menu',
        ...
        $this->add_control(
            ...
            [
                'label' => __('Icon Color', 'rehomes-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Main Menu', 'rehomes-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'show_when_hover',
            [
                'label' => __('Show When Hover', 'rehomes-core'),
                'type' => Controls_Manager::SWITCHER,
                'default' => '',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Mega Menu', 'rehomes-core'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'dot_menu_item',
            [
                'label' => __('Dot Color', 'rehomes-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'color_sub_arrow',
            [
                'label' => __('Sub Arrow Color', 'rehomes-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'bgcolor_sub_arrow',
            [
                'label' => __('Sub Arrow Background Color', 'rehomes-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'color_divider',
            [
                'label' => __('Divider Color', 'rehomes-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Pointer Color', 'rehomes-core'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'pointer_height',
            [
                'label' => __('Pointer Height', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Horizontal Padding', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->add_responsive_control(
            ...
            [
                'label' => __('Vertical Padding', 'rehomes-core'),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'max' => 50,
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __('Dropdown', 'rehomes-core'),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
...
//                    'dropdown_layout!'        => 'canvas',
        ...
        $this->add_control(
            ...
            [
                'raw' => __('On desktop, this will affect the submenu. On mobile, this will affect the entire menu.', 'rehomes-core'),
                'type' => Controls_Manager::RAW_HTML,
        ...
        $this->add_control(
            'show_line',
            [
                'label' => __('Show Line', 'rehomes-core'),
                'type' => Controls_Manager::SWITCHER,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .e--pointer-sub-line .elementor-sub-item:before' => 'background: {{VALUE}};',
                ],
                'condition' => [
                    'show_line!' => '',
                ],
...
//        $args['menu_id'] = 'menu-' . $this->get_nav_menu_index() . '-' . $this->get_id();
        ...
        if ($settings['show_line']){
            $this->add_render_attribute('main-menu', 'class', 'e--pointer-sub-line');
        }
        ?>
