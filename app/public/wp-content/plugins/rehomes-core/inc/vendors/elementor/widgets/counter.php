...
class OSF_Elementor_Counter extends Widget_Counter {
    ...
    public function get_title() {
        return __('Counter', 'rehomes-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'starting_number',
            [
                'label'   => __('Starting Number', 'rehomes-core'),
        ...
        $this->add_control(
            'ending_number',
            [
                'label'   => __('Ending Number', 'rehomes-core'),
                'type'    => Controls_Manager::NUMBER,
                'default' => 100,
            ]
        );
        ...
        $this->add_control(
            'prefix',
            [
                'label'       => __('Number Prefix', 'rehomes-core'),
        ...
        $this->add_control(
            'suffix',
            [
                'label'       => __('Number Suffix', 'rehomes-core'),
                'type'        => Controls_Manager::TEXT,
                'default'     => '',
                'placeholder' => __('Plus', 'rehomes-core'),
            ]
        );
        ...
        $this->add_control(
            'icon_select',
            [
                'label'     => __('Icon select', 'rehomes-core'),
                'type'      => Controls_Manager::SELECT,
                'default'   => 'use_icon',
                'options'   => [
                    'use_icon'  => __('Use Icon', 'rehomes-core'),
                    'use_image' => __('Use Image', 'rehomes-core'),
                ],
                'condition' => [
                    'show_icon' => 'yes',
                ],
        ...
        $this->add_control(
            'thousand_separator',
            [
                'label'     => __('Thousand Separator', 'rehomes-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'label_on'  => __('Show', 'rehomes-core'),
                'label_off' => __('Hide', 'rehomes-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Separator', 'rehomes-core'),
                'type'      => Controls_Manager::SELECT,
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'default'     => __('Cool Number', 'rehomes-core'),
                'placeholder' => __('Cool Number', 'rehomes-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'        => Controls_Manager::TEXT,
                'label_block' => true,
                'placeholder' => __('Sub Title', 'rehomes-core'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'placeholder' => __('Description...', 'rehomes-core'),
            ]
        );
        ...
        $this->add_control(
            'position',
            [
                'label'        => __('Content Align', 'rehomes-core'),
                'type'         => Controls_Manager::CHOOSE,
                'options'      => [
                    'left' => [
                        'title' => __('Left', 'rehomes-core'),
        ...
        $this->start_controls_section(
            'section_image',
            [
                'label'     => __('Image & SVG', 'rehomes-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition'  => [
                    'icon_select' => 'use_image',
                    'show_icon'   => 'yes',
