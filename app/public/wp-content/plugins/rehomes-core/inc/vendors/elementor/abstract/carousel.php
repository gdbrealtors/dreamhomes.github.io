...
abstract class OSF_Elementor_Carousel_Base extends Elementor\Widget_Base {
    ...
    protected function add_control_carousel($condition = array()) {
        $this->start_controls_section(
            ...
            [
                'label'     => __('Carousel Options', 'rehomes-core'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => 'dots',
                'options'   => [
                    'both'   => __('Arrows and Dots', 'rehomes-core'),
                    'arrows' => __('Arrows', 'rehomes-core'),
                    'dots'   => __('Dots', 'rehomes-core'),
        ...
        $this->add_control(
            'nav_style',
            [
                'label'        => __('Nav Style', 'rehomes-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => '',
                'options'      => [
        ...
        $this->add_control(
            'nav_position',
            [
                'label'        => __('Nav Position', 'rehomes-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'top',
                'options'      => [
        ...
        $this->add_control(
            'nav_align',
            [
                'label'        => __('Nav Align', 'rehomes-core'),
                'type'         => Controls_Manager::SELECT,
                'default'      => 'right',
                'options'      => [
        ...
        $this->add_responsive_control(
            'dots_align',
            [
                'label'        => __('Dots alignment', 'rehomes-core'),
        ...
        $this->add_responsive_control(
            'nav_spacing_center',
            [
                'label'      => __('Nav Spacing Horizontal', 'rehomes-core'),
        ...
        $this->add_responsive_control(
            ...
            [
                'label'      => __('Nav Spacing Vertical', 'rehomes-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => -100,
        ...
        $this->add_control(
            'pause_on_hover',
            [
                'label'     => __('Pause on Hover', 'rehomes-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'autoplay',
            [
                'label'     => __('Autoplay', 'rehomes-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
        ...
        $this->add_control(
            'autoplay_speed',
            [
                'label'     => __('Autoplay Speed', 'rehomes-core'),
                'type'      => Controls_Manager::NUMBER,
                'default'   => 5000,
                'condition' => [
                    'autoplay'        => 'yes',
        ...
        $this->add_control(
            'infinite',
            [
                'label'     => __('Infinite Loop', 'rehomes-core'),
                'type'      => Controls_Manager::SWITCHER,
                'default'   => 'yes',
                'condition' => [
                    'enable_carousel' => 'yes'
...
//        );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Carousel', 'rehomes-core'),
        ...
        $this->add_control(
            'carousel_navs_color',
            [
                'label'     => __('Nav Background Color', 'rehomes-core'),
        ...
        $this->add_control(
            'carousel_effect_opacity',
            [
                'label'        => __('Effect Opacity', 'rehomes-core'),
                'type'         => Controls_Manager::SWITCHER,
                'return_value' => 'yes',
                'prefix_class' => 'carousel-effect-opacity-'
            ]
        );
        ...
        $this->add_responsive_control(
            'carousel_arrow_size',
            [
                'label'      => __('Arrow Size', 'rehomes-core'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min'  => 0,
                ...
                'size_units' => ['px', 'em'],
                'selectors'  => [
                    '{{WRAPPER}} .owl-nav [class*="owl-"]:before' => 'font-size: {{SIZE}}{{UNIT}}',
                ],
                'conditions' => [
                    'relation' => 'and',
                    'terms'    => [
        ...
        $this->add_control(
            'carousel_nav_color',
            [
                'label'     => __('Arrow Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .owl-theme.owl-carousel .owl-nav [class*="owl-"]:not(:hover):before' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Arrow Background Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .owl-theme.owl-carousel .owl-nav [class*="owl-"]:not(:hover):before, {{WRAPPER}} .owl-theme.owl-carousel .owl-nav [class*="owl-"]:not(:hover)' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Arrow Border Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .owl-theme.owl-carousel .owl-nav [class*="owl-"]:not(:hover):before' => 'border-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .owl-theme.owl-carousel .owl-nav [class*="owl-"]:hover:before, {{WRAPPER}} .owl-theme.owl-carousel .owl-nav [class*="owl-"]:hover' => 'background-color: {{VALUE}};',
                ],
            ]
        );
