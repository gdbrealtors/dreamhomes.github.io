...
class OSF_Elementor_Header_Group extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return __('Opal Header Group', 'rehomes-core');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'show_wishlist',
            [
                'label' => __('Show wishlist', 'rehomes-core'),
        ...
        $this->add_control(
            'show_search',
            [
                'label' => __('Show search form', 'rehomes-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_account',
            [
                'label' => __('Show account', 'rehomes-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_cart',
            [
                'label' => __('Show cart', 'rehomes-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section(
            'wishlist_config',
            [
                'label'     => __('WooCommerce Wishlist', 'rehomes-core'),
                'condition' => [
                    'show_wishlist!' => '',
                ],
            ]
        ...
        $this->add_control(
            'show_subtotal',
            [
                'label' => __('Show Total', 'rehomes-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => __('Wishlist', 'rehomes-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'search_config',
            [
                'label'     => __('Search Form', 'rehomes-core'),
                'condition' => [
                    'show_search!' => '',
                ],
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'options'            => [
                    ...
                    'minimal'     => __('Minimal', 'rehomes-core'),
                    'full_screen' => __('Full Screen', 'rehomes-core'),
                ],
        ...
        $this->add_control(
            'placeholder',
            [
                'label'     => __('Placeholder', 'rehomes-core'),
                'type'      => Controls_Manager::TEXT,
                'separator' => 'before',
                'default'   => __('Search', 'rehomes-core') . '...',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options'      => [
                    'search' => [
                        'title' => __('Search', 'rehomes-core'),
                        'icon'  => 'opal-icon-search',
                    ],
                    'arrow'  => [
                        'title' => __('Arrow', 'rehomes-core'),
        ...
        $this->add_control(
            ...
            [
                'label'   => __('Text', 'rehomes-core'),
                'type'    => Controls_Manager::TEXT,
                'default' => __('Account', 'rehomes-core'),
            ]
        );
        ...
        $this->start_controls_section(
            'cart_content',
            [
                'label'     => __('WooCommerce Cart', 'rehomes-core'),
                'condition' => [
                    'show_cart!' => '',
                ],
            ]
        ...
        $this->add_control(
            'show_items',
            [
                'label' => __('Show Count Text', 'rehomes-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_amount',
            [
                'label' => __('Show Amount', 'rehomes-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->add_control(
            'show_count',
            [
                'label' => __('Show Count', 'rehomes-core'),
                'type'  => Controls_Manager::SWITCHER,
            ]
        );
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Wishlist Style', 'rehomes-core'),
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Background Hover Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Title Hover Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_input_style',
            [
                'label'     => __('Search Form Style', 'rehomes-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_search!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => __('Overlay Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_border_width',
            [
                'label'     => __('Border Size', 'rehomes-core'),
                'type'      => Controls_Manager::DIMENSIONS,
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label'     => __('Account Style', 'rehomes-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_account' => 'yes',
                ],
        ...
        $this->add_control(
            'indicator_style',
            [
                'label'     => __('INDICATOR', 'rehomes-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'indicator_color',
            [
                'label'     => __('Indicator Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'section_lable_style',
            [
                'label'     => __('Cart Style', 'rehomes-core'),
                'tab'       => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'show_cart' => 'yes',
                ],
        ...
        $this->add_control(
            'amount_color',
            [
                'label'     => __('Amount Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label'     => __('COUNT TEXT', 'rehomes-core'),
                'type'      => Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'count_text_color',
            [
                'label'     => __('Count Text Color', 'rehomes-core'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="elementor-search-form__container">
                ...
                <div class="w-100 elementor-search-form--full-screen-inner">
                    ...
                    <div class="dialog-lightbox-close-button dialog-close-button">
                        ...
                        <span class="elementor-screen-only"><?php esc_html_e('Close', 'rehomes-core'); ?></span>
                    </div>
                </div>
            <?php endif ?>
            </div>
            ...
            <a data-toggle="toggle" class="cart-contents header-button" href="<?php echo esc_url(wc_get_cart_url()); ?>">
                ...
                <?php if (!empty(WC()->cart) && WC()->cart instanceof WC_Cart): ?>
                    ...
                    <?php if ($settings['show_items']): ?>
                        <span class="count-text"><?php echo wp_kses_data(_n("item", "items", WC()->cart->get_cart_contents_count(), "rehomes-core")); ?></span>
                    <?php endif; ?>
    ...
    protected function render_account() {
        ...
        <div class="site-header-account">
            ...
            if (is_user_logged_in()) {
                ...
                if (!$settings['show_icon_account']) {
                    echo '<span class="text-account ">' . esc_html__('Login', 'rehomes-core') . '</span>';
                    echo '<span class="line-center">|</span>';
                    echo '<span class="text-account">' . esc_html__('Sign Up', 'rehomes-core') . '</span>';
                }
            }

            if ($settings['show_submenu_indicator']) {
                echo '<span class="fa fa-angle-down submenu-indicator" aria-hidden="true"></span>';
            }
